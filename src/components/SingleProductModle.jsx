...
function SingleProductModle({ product, addCart, closeModal }) {
                    ...
                    <div className="modal-body">
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <button
                                ...
                                onClick={(e) => setCartQty((pre) => (pre === 1 ? 1 : pre - 1))}
                            >
                            ...
                            <button
                                ...
                                id="button-addon2"
                                aria-label="Decrease quantity"
                                onClick={(e) => setCartQty((pre) => pre + 1)}
                            >
...
export default SingleProductModle